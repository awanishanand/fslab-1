...
int main()
{
student s1("awanish","018","ise","6");
student s2("atul","001","cse","5");
student s3("sameer","002","ise","8");
FLRfile f("out.txt",100);
f.writerecord(s1.pack(100));
f.writerecord(s2.pack(100));
f.writerecord(s3.pack(100));
f.deleterecord("name","awanish");
return 0;
}
